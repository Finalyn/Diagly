export type ProjectStatus = 'CREATED' | 'VISIT_PLANNED' | 'DIAGNOSTIC_IN_PROGRESS' | 'REPORT_DRAFT' | 'REPORT_DONE' | 'TENDER_OPEN' | 'TENDER_CLOSED' | 'WORK_IN_PROGRESS' | 'CLOSED'
...
export const statusLabels: Record<ProjectStatus, string> = {
  CREATED: 'Cree', VISIT_PLANNED: 'Visite planifiee', DIAGNOSTIC_IN_PROGRESS: 'Diagnostic en cours',
  REPORT_DRAFT: 'Rapport brouillon', REPORT_DONE: 'Rapport termine', TENDER_OPEN: "Appel d'offres",
  TENDER_CLOSED: 'AO cloture', WORK_IN_PROGRESS: 'Travaux en cours', CLOSED: 'Cloture'
}
export const statusColors: Record<ProjectStatus, string> = {
  CREATED: 'bg-gray-400', VISIT_PLANNED: 'bg-blue-400', DIAGNOSTIC_IN_PROGRESS: 'bg-blue-500',
  REPORT_DRAFT: 'bg-yellow-500', REPORT_DONE: 'bg-green-500', TENDER_OPEN: 'bg-violet-500',
  TENDER_CLOSED: 'bg-violet-700', WORK_IN_PROGRESS: 'bg-orange-500', CLOSED: 'bg-green-700'
}
...
export const mockProjects: Project[] = [
  { id: 'prj_1', name: 'Renovation Residence du Lac', address: 'Av. de Cour 42', city: 'Lausanne', canton: 'VD', parcelNumber: 'VD-1234', yearBuilt: 1972, buildingType: 'LOGEMENT', nbApartments: 24, nbFloors: 6, floorHeight: 2.7, nbStaircases: 2, floorArea: 3200, builtArea: 580, facadeArea: 2800, terrainArea: 1200, perimeter: 120, windowPct: 0.30, honoraryPct: 12, reservePct: 5, status: 'DIAGNOSTIC_IN_PROGRESS', totalBudget: 1850000, createdAt: new Date('2025-11-15'), updatedAt: new Date('2026-03-20') },
  { id: 'prj_2', name: 'Ecole primaire des Paquis', address: 'Rue de Zurich 18', city: 'Geneve', canton: 'GE', parcelNumber: 'GE-5678', yearBuilt: 1965, buildingType: 'SCOLAIRE', nbApartments: 0, nbFloors: 3, floorHeight: 3.2, nbStaircases: 2, floorArea: 2400, builtArea: 850, facadeArea: 1920, terrainArea: 3500, perimeter: 140, windowPct: 0.35, honoraryPct: 10, reservePct: 5, status: 'REPORT_DONE', totalBudget: 980000, createdAt: new Date('2025-09-01'), updatedAt: new Date('2026-02-10') },
  { id: 'prj_3', name: 'Immeuble Grand-Rue', address: 'Grand-Rue 15', city: 'Fribourg', canton: 'FR', parcelNumber: 'FR-9012', yearBuilt: 1988, buildingType: 'LOGEMENT', nbApartments: 16, nbFloors: 5, floorHeight: 2.6, nbStaircases: 1, floorArea: 2100, builtArea: 420, facadeArea: 1820, terrainArea: 650, perimeter: 90, windowPct: 0.28, honoraryPct: 11, reservePct: 5, status: 'TENDER_OPEN', totalBudget: 720000, createdAt: new Date('2025-10-20'), updatedAt: new Date('2026-03-15') },
  { id: 'prj_4', name: 'Hotel Beau-Rivage', address: 'Quai du Mont-Blanc 8', city: 'Montreux', canton: 'VD', yearBuilt: 1955, buildingType: 'HOTEL', nbApartments: 45, nbFloors: 7, floorHeight: 3.0, nbStaircases: 3, floorArea: 5600, builtArea: 900, facadeArea: 4200, terrainArea: 2800, perimeter: 160, windowPct: 0.32, honoraryPct: 13, reservePct: 5, status: 'CREATED', totalBudget: 3200000, createdAt: new Date('2026-03-01'), updatedAt: new Date('2026-03-01') },
  { id: 'prj_5', name: 'Centre administratif Numa Droz', address: 'Rue Numa-Droz 2', city: 'Neuchatel', canton: 'NE', parcelNumber: 'NE-3456', yearBuilt: 1980, buildingType: 'ADMINISTRATIF', nbApartments: 0, nbFloors: 4, floorHeight: 2.8, nbStaircases: 2, floorArea: 3800, builtArea: 1050, facadeArea: 2560, terrainArea: 1800, perimeter: 130, windowPct: 0.40, honoraryPct: 10, reservePct: 5, status: 'CLOSED', totalBudget: 1450000, createdAt: new Date('2024-06-15'), updatedAt: new Date('2025-12-20') },
  { id: 'prj_6', name: 'Residence Les Alpes', address: 'Chemin des Cretes 12', city: 'Sion', canton: 'VS', yearBuilt: 1990, buildingType: 'LOGEMENT', nbApartments: 18, nbFloors: 5, floorHeight: 2.6, nbStaircases: 1, floorArea: 2400, builtArea: 480, windowPct: 0.28, honoraryPct: 11, reservePct: 5, status: 'WORK_IN_PROGRESS', totalBudget: 920000, createdAt: new Date('2025-06-10'), updatedAt: new Date('2026-03-28') },
  { id: 'prj_7', name: 'Groupe scolaire Vinet', address: 'Av. Vinet 30', city: 'Lausanne', canton: 'VD', yearBuilt: 1958, buildingType: 'SCOLAIRE', nbApartments: 0, nbFloors: 3, floorHeight: 3.4, nbStaircases: 3, floorArea: 4200, builtArea: 1400, windowPct: 0.35, honoraryPct: 10, reservePct: 5, status: 'DIAGNOSTIC_IN_PROGRESS', totalBudget: 2100000, createdAt: new Date('2026-01-15'), updatedAt: new Date('2026-04-02') },
  { id: 'prj_8', name: 'Immeuble Chauderon', address: 'Pl. Chauderon 4', city: 'Lausanne', canton: 'VD', yearBuilt: 1935, buildingType: 'LOGEMENT', nbApartments: 32, nbFloors: 7, floorHeight: 2.9, nbStaircases: 2, floorArea: 4800, builtArea: 700, windowPct: 0.25, honoraryPct: 12, reservePct: 5, status: 'REPORT_DRAFT', totalBudget: 3500000, createdAt: new Date('2025-08-20'), updatedAt: new Date('2026-03-30') },
  { id: 'prj_9', name: 'Centre commercial Balexert', address: 'Av. Louis-Casai 27', city: 'Geneve', canton: 'GE', yearBuilt: 1971, buildingType: 'COMMERCIAL', nbApartments: 0, nbFloors: 2, floorHeight: 4.0, nbStaircases: 4, floorArea: 12000, builtArea: 6000, windowPct: 0.45, honoraryPct: 8, reservePct: 5, status: 'TENDER_OPEN', totalBudget: 5800000, createdAt: new Date('2025-04-01'), updatedAt: new Date('2026-02-15') },
  { id: 'prj_10', name: 'Villa Weissenstein', address: 'Weissensteinstr. 45', city: 'Berne', canton: 'BE', yearBuilt: 2005, buildingType: 'LOGEMENT', nbApartments: 1, nbFloors: 2, floorHeight: 2.7, nbStaircases: 1, floorArea: 280, builtArea: 160, windowPct: 0.32, honoraryPct: 15, reservePct: 5, status: 'CREATED', totalBudget: 180000, createdAt: new Date('2026-04-01'), updatedAt: new Date('2026-04-01') },
  { id: 'prj_11', name: 'EMS Les Jardins', address: 'Route de Berne 8', city: 'Fribourg', canton: 'FR', yearBuilt: 1982, buildingType: 'AUTRE', nbApartments: 42, nbFloors: 3, floorHeight: 2.8, nbStaircases: 2, floorArea: 3600, builtArea: 1200, windowPct: 0.30, honoraryPct: 10, reservePct: 5, status: 'VISIT_PLANNED', totalBudget: 1650000, createdAt: new Date('2026-03-20'), updatedAt: new Date('2026-04-05') },
  { id: 'prj_12', name: 'Parking Riponne', address: 'Pl. de la Riponne', city: 'Lausanne', canton: 'VD', yearBuilt: 1975, buildingType: 'AUTRE', nbApartments: 0, nbFloors: 4, floorHeight: 2.5, nbStaircases: 2, floorArea: 8000, builtArea: 2000, windowPct: 0.05, honoraryPct: 8, reservePct: 5, status: 'DIAGNOSTIC_IN_PROGRESS', totalBudget: 4200000, createdAt: new Date('2025-12-01'), updatedAt: new Date('2026-04-08') },
  { id: 'prj_13', name: 'PPE Montbrillant', address: 'Rue de Montbrillant 16', city: 'Geneve', canton: 'GE', yearBuilt: 1968, buildingType: 'LOGEMENT', nbApartments: 20, nbFloors: 6, floorHeight: 2.7, nbStaircases: 1, floorArea: 2800, builtArea: 500, windowPct: 0.30, honoraryPct: 12, reservePct: 5, status: 'REPORT_DONE', totalBudget: 1100000, createdAt: new Date('2025-07-10'), updatedAt: new Date('2026-01-20') },
  { id: 'prj_14', name: 'Temple de Lutry', address: 'Grand-Rue 22', city: 'Lutry', canton: 'VD', yearBuilt: 1577, buildingType: 'AUTRE', nbApartments: 0, nbFloors: 1, floorHeight: 8.0, nbStaircases: 1, floorArea: 400, builtArea: 400, windowPct: 0.15, honoraryPct: 15, reservePct: 10, status: 'CLOSED', totalBudget: 890000, createdAt: new Date('2024-01-15'), updatedAt: new Date('2025-10-30') },
  { id: 'prj_15', name: 'Usine Tornos', address: 'Rue Industrielle 3', city: 'Moutier', canton: 'BE', yearBuilt: 1962, buildingType: 'INDUSTRIEL', nbApartments: 0, nbFloors: 2, floorHeight: 5.0, nbStaircases: 1, floorArea: 6000, builtArea: 3000, windowPct: 0.20, honoraryPct: 8, reservePct: 5, status: 'TENDER_CLOSED', totalBudget: 2800000, createdAt: new Date('2025-03-01'), updatedAt: new Date('2026-02-28') },
]
